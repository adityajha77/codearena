...
let idl = JSON.parse(fs.readFileSync("./src/lib/code_arena_v2.json", "utf8"));
delete idl.metadata; // remove spec
// Also change the version string if needed, but let's test just removing metadata
